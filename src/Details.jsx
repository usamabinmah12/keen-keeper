            ...
            <div className="card card-side bg-base-100 shadow-sm flex justify-between">
                <div className="">
                    ...
                    <div className="card-body flex flex-col items-center">
                        ...
                        <div className="border border-amber-200 p-4">
                            <h2 className='flex items-center gap-1 justify-center text-red-600'><MdDeleteOutline /> Delete</h2>
                        </div>
                ...
                <div className="card-body">
                    ...
                    <div className="">
                        ...
                        <div className="text-2xl p-2 font-semibold">Quick Check-In</div>
                        <div className="grid grid-cols-3 gap-3 my-9">
                            <button
                                onClick={() => handleClickedAdd('call')}
                                className="rounded-3xl hover:bg-amber-300 flex flex-col items-center border border-amber-200 p-3 w-full"
                            >
                                <img src={img1} alt="call" />
                                <p className='text-3xl m-2'>Call</p>
                            </button>

                            <button
                                onClick={() => handleClickedAdd('text')}
                                className="rounded-3xl hover:bg-amber-300 flex flex-col items-center border border-amber-200 p-3"
                            >
                            ...
                            <button
                                onClick={() => handleClickedAdd('video')}
                                className="rounded-3xl hover:bg-amber-300 flex flex-col items-center border border-amber-200 p-3"
                            >
